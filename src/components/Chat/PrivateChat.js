    ...
    *  Paivittaa kaverit listalta
    ...
    return (
        <div id="privatechat">
            <Modal show={show}>
                <Modal.Header>
                    <Modal.Title>Anna viesti</Modal.Title>
                </Modal.Header>
                <Modal.Body>Ole hyvä ja anna viesti!</Modal.Body>
                <Modal.Footer>
                    <button onClick={() => setShow(false)}>Selvä</button>
                </Modal.Footer>
            </Modal>
            ...
            <section className="viestikentta">
                ...
                <section id="sisalto" ref={sisalto}>
                    ...
                    {valittuID == 0 && <h1>Aloita napsauttamalla kaveria!</h1>}
